...
namespace iBourgeois\Spark\Http\Controllers\Auth;
...
use iBourgeois\Spark\Subscriptions\Plan;
use iBourgeois\Spark\Events\User\Registered;
use iBourgeois\Spark\Events\User\Subscribed;
use iBourgeois\Spark\InteractsWithSparkHooks;
use Illuminate\Contracts\Auth\Authenticatable;
use Illuminate\Foundation\Auth\ThrottlesLogins;
use iBourgeois\Spark\Events\Team\Created as TeamCreated;
use Illuminate\Foundation\Validation\ValidatesRequests;
use iBourgeois\Spark\Contracts\Repositories\UserRepository;
use iBourgeois\Spark\Contracts\Repositories\TeamRepository;
...
class AuthController extends Controller
{
     ...
     *
     * @var \iBourgeois\Spark\Contracts\Repositories\TeamRepository
     */
    protected $teams;
