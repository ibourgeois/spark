...
namespace iBourgeois\Spark\Services\Auth\TwoFactor;

use Exception;
use GuzzleHttp\Client as HttpClient;
use iBourgeois\Spark\Contracts\Auth\TwoFactor\Provider;
use iBourgeois\Spark\Contracts\Auth\TwoFactor\Authenticatable as TwoFactorAuthenticatable;
...
class Authy implements Provider
{
     ...
     *
     * @param  \iBourgeois\Spark\Contracts\Auth\TwoFactor\Authenticatable  $user
     * @return bool
     */
